...
var ground, invisibleGround, groundImage,back;
...
function preload(){
  trex_running = loadAnimation("newTrex1.gif","newTrex2.gif","newTrex3.gif");
  trex_collided = loadAnimation("newTrexCollided.gif");
